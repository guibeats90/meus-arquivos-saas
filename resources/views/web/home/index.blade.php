                ...
                @if(count($gamesExclusives) > 0)
                    ...
                    <div class="d-steam-cards js-steamCards">
                        ...
                        ?>
                            ...
                            data-need-bet="{{ in_array($gamee['uuid'], ['sub','mario','flappy','fruit','candy','sonic','jetpack','guitarhero','tample','jurassiccash','flappycopter','mario2','dino','angry','megaman']) ? 'yes' : 'no' }}">
